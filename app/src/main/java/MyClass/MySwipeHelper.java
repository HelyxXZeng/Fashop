...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public class MyButton {
        ...
        private MyButtonClickListener lisenter;
        private Context context;
        private Resources resources;

        public MyButton(Context context, String text, int textSize, int imageResId ,int color, MyButtonClickListener lisenter) {
            this.text = text;
...
//        }
        ...
        public void onDraw(Canvas c, RectF rectF, int pos) {
            ...
            float x = rectF.left + cWidth / 2f;
            float y = rectF.top + cHeight / 2f + r.height() / 2f;
            ...
            if (imageResId == 0) {
                ...
                if (d != null) {
                    ...
                    int left = (int) (x - imageWidth / 2f);
                    int top = (int) (y - imageHeight / 2f);
                    int right = (int) (x + imageWidth / 2f);
                    int bottom = (int) (y + imageHeight / 2f);
